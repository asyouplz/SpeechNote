...
export class AudioValidator {
    ...
    private analyzeSilence(audio: ArrayBuffer): SilenceAnalysisResult {
        try {
            ...
            const isSilent =
                averageAmplitude < AUDIO_VALIDATION.SILENCE_THRESHOLD &&
                peak <
                    AUDIO_VALIDATION.SILENCE_THRESHOLD * AUDIO_VALIDATION.SILENCE_PEAK_MULTIPLIER;
...
export class ContentTypeMapper {
    ...
    static getContentType(detectedFormat?: string): string {
        if (
            detectedFormat &&
            AUDIO_FORMATS.CONTENT_TYPES[detectedFormat as keyof typeof AUDIO_FORMATS.CONTENT_TYPES]
        ) {
            return AUDIO_FORMATS.CONTENT_TYPES[
                detectedFormat as keyof typeof AUDIO_FORMATS.CONTENT_TYPES
            ];
        }
